        ...
        <div className="bg-gray-100 h-screen flex flex-col items-center justify-center dark:bg-gray-900">
            <div className="w-full max-w-md bg-white shadow-md px-8 py-6 rounded-lg dark:bg-gray-800">
                ...
                <form onSubmit={handleSubmit}>
                    {passwordsMatch && (
                        <p className="text-red-500 text-xs mb-4">Les mots de passe ne correspondent pas.</p>
                    )}
                    <div className="mb-4">
                        <label htmlFor="password" className="block text-sm font-medium text-gray-700 dark:text-gray-300 pb-3">
                    ...
                    <div className="mb-4">
                        <label htmlFor="confirm-password" className="block text-sm font-medium text-gray-700 dark:text-gray-300 pb-3">
