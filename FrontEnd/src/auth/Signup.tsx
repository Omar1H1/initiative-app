...
import { UserSignupInfo } from "../types/UserSignupInfo.ts";

const api = new Axios().getInstance();

const Signup = (props: UserSignupInfo) => {
  const { userFirstName, userLastName, userEmail } = props;
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div>
            <label
              ...
              className="block text-gray-700 dark:text-gray-300 font-bold mb-2"
            >
              Pouvez vous dans 250 caracteres expliquer votre projet ou bien
              domain d'expertise
            </label>
            <textarea
