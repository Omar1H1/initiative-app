...
const Hero = () => {
  ...
  return (
    <div className="flex flex-col items-center sm:items-stretch mt-60 mx-20 dark:bg-gray-900 h-screen">
        <div className="flex flex-col md:flex-row min-h-min md:h-[600px] w-full px-6 py-12 md:px-20 bg-gradient-to-b from-[#360033] to-[#0b8793] text-white rounded-lg md:rounded-3xl overflow-hidden">
            ...
            <div
                className="md:w-1/2 flex flex-col justify-center items-center md:items-start text-center md:text-left space-y-6">
        ...
        <div className="flex justify-center items-center md:w-1/2 mt-10 md:mt-0">
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 w-full max-w-lg">
            ...
            <img
              ...
              className="w-full h-40 object-cover object-top rounded-lg shadow-lg"
            />
            <img
              alt=""
