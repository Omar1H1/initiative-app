            ...
            >
              ...
              <div className="flex space-x-2">
                {notification.status === "pending" && (
                  <>
                    <ImCheckmark
                      className="text-green-500 cursor-pointer dark:hover:bg-white dark:hover:scale-125 dark:rounded-md"
                      onClick={(e) => handleAccept(e, notification.id)}
                    />
                    <RxCross2
                      className="text-red-500 cursor-pointer dark:hover:bg-white dark:hover:scale-125 dark:rounded-md"
